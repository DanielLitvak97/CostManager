// Mock the user and cost models so the tests do not use the real MongoDB database.
...
describe('Users microservice', () => {
    ...
    // Verify that the endpoint returns all users.
    ...
    // Verify that an empty array is returned when there are no users.
    ...
    // Verify that a user's details and total cost amount are returned.
    ...
    // Verify that a user with no costs has a total of zero.
    ...
    // Verify that an invalid user ID is rejected before accessing the database.
    ...
    // Verify that a 404 error is returned when the requested user does not exist.
    ...
    // Verify that database errors are returned correctly for user details.
    ...
    // Verify that a valid new user can be added
    ...
    // Verify that missing required user properties are rejected.
    ...
    // Verify that user names cannot be empty.
    ...
    // Verify that an invalid birthday is rejected.
    ...
    // Verify that duplicate user IDs are not allowed.
    ...
    // Verify that database errors during user creation are returned correctly.
